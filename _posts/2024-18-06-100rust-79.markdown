---
layout: post
title:  "Rust challenge 79/100 - probe.rs"
...
Here are some important things to know about rust embedded development. Rust 1.0 came out in 2015, embedded_hal 1.0 only recently. 
...
- Targets have varying level of support. Best supported are ARM / RISC. There is a platform support page that puts support in different categories. Tier-1 are the best supported. https://doc.rust-lang.org/nightly/rustc/platform-support.html#tier-1-with-host-tools
